...
@:include("Urho3d/Source/Engine/Urho2D/CollisionShape2D.h")
/**
 * ...
 * @author ...
 */
@:unreflective
@:native("Urho3D::CollisionShape2D *")
extern class Urho_CollisionShape2D extends Urho_Component
{
	@:native("new Urho3D::CollisionShape2D")
	public static function create(context:Urho_Context):Urho_CollisionShape2D;
}
